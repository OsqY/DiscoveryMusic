...
public class SeedingController : ControllerBase
{
  ...
  {
    var path = Path.Combine(Directory.GetCurrentDirectory(), "Data/Seeding", "rym_top_5000_all_time(1).csv");
    ...
    using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
    {
      ...
      {
        var artist = await _context.Artists.FirstOrDefaultAsync(a => a.Name == record.ArtistName);
